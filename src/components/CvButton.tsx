...
const CvButton = ({href, download, text, arrow}: CvButtonProps) => {
  return (
    <>
      <a href={href} download={download} className="relative inline-fle h-12 overflow-hidden rounded-full p-[1.15px]">
       ...
       <span className="kode-mono-light inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-gradient-to-br from-stone-300 from-55% to-indigo-200  hover:bg-gradient-to-br hover:from-stone-400 hover:from-55% hover:to-indigo-200 px-8 hover:px-[4rem] text-stone-700 hover:text-stone-100 backdrop-blur-3xl transition">
          {text}
