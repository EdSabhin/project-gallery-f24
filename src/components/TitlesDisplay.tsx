      ...
      {Object.values(projects).map((project) => (
        <div key={project.id} className="item">
          ...
          <div className="content">
            ...
            <div className="buttons flex flex-col  -mmt-14 gap-10">
              <div className="flex gap-12 lg:gap-12">
                <LinkButton href={project.href} text="Visit" className="" />
                <LinkButton href="/cv" text="View CV" className="desktop-only" />
              </div>
            </div>
          </div>
        </div>
